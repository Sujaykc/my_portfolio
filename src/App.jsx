...
import profileImageUrl from '../assets/sujayphoto3.jpg';
//Production testing
...
function App() {
  ...
  return <>
    ...
    <section id="hero">
      <div className="hero-content"><div className="hero-badge"><i className="fas fa-bolt" /> Available for Backend Roles</div><h1 className="hero-name">Sujay K C.</h1><div className="hero-typing">I'm a <span className="accent-line">{roleText}</span><span className="cursor-blink">|</span></div><p className="hero-desc">Building scalable backends that power real products. Based in Bengaluru, crafting APIs, audio pipelines, and automation systems that actually work in production.</p><div className="hero-cta"><a href="#projects" className="btn-primary">View My Work <i className="fas fa-arrow-right" /></a><a href={resumeUrl} className="btn-resume glass-panel" target="_blank" rel="noreferrer"><i className="fas fa-file-alt" /> Resume</a></div></div>
      <Reveal className="hero-visual"><div className="hero-photo-container"><img src={profileImageUrl} alt="Sujay K C" className="hero-photo" /></div></Reveal>
    </section>
